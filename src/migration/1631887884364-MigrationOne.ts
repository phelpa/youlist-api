...
export class MigrationOne1631887884364 implements MigrationInterface {
    name = 'MigrationOne1631887884364'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Videos" ("vid_id" SERIAL NOT NULL, "vid_title" character varying(255) NOT NULL, "vid_description" character varying(255) NOT NULL, "vid_youtube_id" character varying(255) NOT NULL, "vid_lst_id" integer NOT NULL, "prd_created" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_232245cbe0fb357a1098919bb7d" PRIMARY KEY ("vid_id"))`);
        await queryRunner.query(`CREATE TABLE "Annotations" ("ant_id" SERIAL NOT NULL, "ant_videotime" integer NOT NULL, "ant_text" character varying(255) NOT NULL, "ant_vid_id" integer NOT NULL, "ant_created" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_42243e89afe964173f472249e25" PRIMARY KEY ("ant_id"))`);
