...
export class MigrationOne1631230222351 implements MigrationInterface {
    name = 'MigrationOne1631230222351'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Videos" ("vid_id" SERIAL NOT NULL, "vid_title" character varying(255) NOT NULL, "vid_description" character varying(255) NOT NULL, "vid_ytid" character varying(255) NOT NULL, "vid_lst_id" integer NOT NULL, "prd_created" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_232245cbe0fb357a1098919bb7d" PRIMARY KEY ("vid_id"))`);
