...
import { makeUpdateAccountController } from '../factories/controllers/authentication/update-account/update-account-controller-factory'
...
export default (router: Router): void => {
  ...
  router.post('/update_account', adaptRoute(makeUpdateAccountController()))
}
